...
4. Read `docs/stories/<StoryID>_UserStory.md` — ACs are your review criteria.
...
10. **GO ✅**: all Critical resolved → save `docs/stories/<StoryID>_CodeReview.md`. **NO-GO ❌**: list remaining Critical items.
