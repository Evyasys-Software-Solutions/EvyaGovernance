...
2. Read `docs/stories/<StoryID>_TestPlan.md`. If any TC has no recorded outcome (pass/fail/blocked), stop and ask the user to fill it in first. **Do not proceed until all TCs have outcomes.**
...
6. On approval → save `docs/stories/<StoryID>_ReleaseNotes.md` → ADO **Done** → Teams release card.
