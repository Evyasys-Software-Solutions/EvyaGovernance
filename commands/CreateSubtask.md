...
2. Read `docs/stories/<StoryID>_UserStory.md` in full. List every AC — you must link at least one task to each.
...
8. On approval: save to `docs/stories/<StoryID>_Subtasks.md` → create ADO child Tasks.
